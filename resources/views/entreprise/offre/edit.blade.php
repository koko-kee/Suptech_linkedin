...
@section('content')
    <h5 class="card-title fw-semibold mb-4">EDITION DE L'OFFRE</h5>
    @if(session('success'))
        ...
        <div class="card-body">
            <form  class="form-group" action="{{route('entreprise.offre.store')}}" method="POST">
                ...
                <div class="row">
                    <div class="col">
                        <div class="mb-5">
                            ...
                            <input type="text" value="{{$offre->libelle}}" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="libelle">
                            @error('libelle')
                    ...
                    <div class="col">
                        <div class="mb-5">
                            ...
                            <input value="{{$offre->localisation}}" placeholder="Ville,Region ou departement" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="localisation">
                            @error('localisation')
                            <span class="text-danger">{{$message}}</span>
                            @enderror
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col">
                        <div class="mb-5">
                            ...
                            <input value="{{$offre->date_limite}}" type="date" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="date_limite">
                            @error('date_limite')
                            <span class="text-danger">{{$message}}</span>
                            @enderror
                        </div>
                ...
                <div class="mb-5">
                    ...
                    <textarea name="description" id="" cols="30" rows="5" class="form-control">{{$offre->description}}</textarea>
                    @error('description')
                    <span class="text-danger">{{$message}}</span>
                    @enderror
                </div>
